...
<body text="white">
<center><h2 style="font-size:60px; color:black;">Add Car Features</h2></center><hr><hr>
<div id="first">
...
<form style="font-size:34px;" action='addcar.php' method="post">
...
<center> <input type="submit" name="sendi" value="SEND"></center>
</form>
</div>
</body>
</html>